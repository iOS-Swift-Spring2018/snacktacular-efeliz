...
class Spot: NSObject, MKAnnotation {
    ...
    convenience init(dictionary: [String: Any]) {
        ...
        self.init(name: name, address: address, coordinate: coordinate, numberOfReviews: numberOfReviews, averageRating: averageRating, postingUserID: postingUserID, documentID: "")
    }
